...
VIDEO_PRODUCTION_DIR = DESKTOP_SKILLS_DIR / "video-production"
VIDEO_QA_DIR = DESKTOP_SKILLS_DIR / "video-qa"

CRITERIA_SKILL_MD = VIDEO_CRITERIA_DIR / "SKILL.md"
PRODUCTION_SKILL_MD = VIDEO_PRODUCTION_DIR / "SKILL.md"
...
CLAUDE_COMMAND = os.environ.get("CLAUDE_COMMAND", "codex")
PRODUCTION_AGENT_COMMAND = os.environ.get("PRODUCTION_AGENT_COMMAND", "codex")
